package net.ionoff.forex.ea.util.calendar;

/**
 * @author Sann Tran <br>
 *         This class is copied from
 *         http://www.informatik.uni-leipzig.de/~duc/amlich/VietCalendar.java. <br>
 *         Thank <strong>Nguyen Ngoc Duc</strong> for his public source code.
 */

public class CalendarConverter {

	public static final double PI = Math.PI;
	public static double timeZone = 7.0;
